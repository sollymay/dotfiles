...
--
myLayout = avoidStruts (tiled ||| ThreeCol nmaster delta ratio ||| Mirror tiled ||| Full)
  where
...
--
main = do
        xmproc <- spawnPipe "xmobar /home/salomonmay/.config/xmobar/xmobarrc"
