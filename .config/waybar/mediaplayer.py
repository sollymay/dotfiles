...
class PlayerManager:
    ...
    def init_player(self, player):
        ...
        try:
            ...
            logger.error(f"Error connecting to player {player.name}: {e}")
    ...
    def on_playback_status_changed(self, player, status, _=None):
        try:
            ...
            logger.error(f"Error in playback status handler: {e}")
    ...
    def on_metadata_changed(self, player, metadata, _=None):
        try:
            ...
            track_info = ""
            if player_name == "spotify" and "mpris:trackid" in metadata.keys() and ":ad:" in str(player.props.metadata):
